...
coef.t98 <- estimateS("T98133", c(13, 15, 20), "V|I", 184, FALSE)
coef.039 <- estimateS("A99039", c(13, 16, 20), "V|I", 184, FALSE)
...
coef.165 <- estimateS("A99165", c(13, 15), "N", 103, FALSE)
...
write(paste("Selection coefficients generated by compute-s.r",
            ...
            sep = "\n"),
      "../out/tables/selection.coefs.txt"
      )
